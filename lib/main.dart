    ...
    return MaterialApp(
      ...
      onGenerateRoute: (settings) {
        if (settings.name == HomeAppRoute.route.name) {
          return HomeAppRoute.page;
        }
        if (settings.name == DetailAppRoute.route.name) {
          DetailAppRoute.route.arguments =
              settings.arguments as RouteAppArguments;

          return DetailAppRoute.page;
        }
      },
      initialRoute: '/',
    );
